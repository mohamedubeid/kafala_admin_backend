...
import { IChildEducationNotes, defaultValue } from '../../../../src/app/shared/model/child-education-notes.model';
import reducer, {
  createEntity,
  deleteEntity,
  getEntities,
  ...
  partialUpdateEntity,
  reset,
} from './child-education-notes.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CHILDEDUCATIONNOTES_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CHILDEDUCATIONNOTES actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CHILDEDUCATIONNOTES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CHILDEDUCATIONNOTES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CHILDEDUCATIONNOTES actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CHILDEDUCATIONNOTES actions', async () => {
      const arg = 42666;
