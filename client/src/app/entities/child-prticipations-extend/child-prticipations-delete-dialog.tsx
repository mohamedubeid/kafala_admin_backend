...
export const ChildPrticipationsDeleteDialog = () => {
  ...
  const childPrticipationsEntity = useAppSelector(state => state.ChildParticipations.entity);
  const updateSuccess = useAppSelector(state => state.ChildParticipations.updateSuccess);
  const handleClose = () => {
    navigate(`/child/${childPrticipationsEntity?.child?.id}/ChildParticipations`);
  };
