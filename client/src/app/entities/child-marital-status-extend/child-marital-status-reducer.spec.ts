...
import { IChildMaritalStatus, defaultValue } from '../../../../src/app/shared/model/child-marital-status.model';
import reducer, {
  createEntity,
  deleteEntity,
  getEntities,
  ...
  partialUpdateEntity,
  reset,
} from './child-marital-status.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CHILDMARITALSTATUS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CHILDMARITALSTATUS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CHILDMARITALSTATUS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CHILDMARITALSTATUS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CHILDMARITALSTATUS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CHILDMARITALSTATUS actions', async () => {
      const arg = 42666;
