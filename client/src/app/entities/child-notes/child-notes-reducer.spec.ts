...
import { IChildNotes, defaultValue } from '../../shared/model/child-notes.model';
import reducer, {
  createEntity,
  deleteEntity,
  getEntities,
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CHILDNOTES_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CHILDNOTES actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CHILDNOTES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CHILDNOTES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CHILDNOTES actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CHILDNOTES actions', async () => {
      const arg = 42666;
