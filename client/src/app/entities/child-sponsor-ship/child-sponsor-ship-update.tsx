...
export const ChildSponsorShipUpdate = () => {
  ...
  const defaultValues = () =>
    isNew
      ? {}
      : {
          sponserConnection: 'RELATIVE',
          sponsershipParty: 'INDIVIDUAL',
          sponsershipDuration: 'MONTHLY',
          ...childSponsorShipEntity,
              ...
              >
                {sponserConnectionValues.map(sponserConnection => (
                  <option value={sponserConnection} key={sponserConnection}>
                    {translate('kafalaApp.SponserConnection.' + sponserConnection ? sponserConnection : SponserConnection.RELATIVE)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
