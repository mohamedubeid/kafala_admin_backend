...
import { INotes, defaultValue } from '../../shared/model/notes.model';
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './notes.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NOTES_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_NOTES actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_NOTES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_NOTES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_NOTES actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_NOTES actions', async () => {
      const arg = 42666;
