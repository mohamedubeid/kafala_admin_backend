...
import { IChildSponsorShipNotes, defaultValue } from '../../shared/model/child-sponsor-ship-notes.model';
import reducer, {
  createEntity,
  deleteEntity,
  getEntities,
  ...
  partialUpdateEntity,
  reset,
} from './child-sponsor-ship-notes.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CHILDSPONSORSHIPNOTES_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CHILDSPONSORSHIPNOTES actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CHILDSPONSORSHIPNOTES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CHILDSPONSORSHIPNOTES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CHILDSPONSORSHIPNOTES actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CHILDSPONSORSHIPNOTES actions', async () => {
      const arg = 42666;
