...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './child-prticipations.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CHILDPRTICIPATIONS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CHILDPRTICIPATIONS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CHILDPRTICIPATIONS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CHILDPRTICIPATIONS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CHILDPRTICIPATIONS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CHILDPRTICIPATIONS actions', async () => {
      const arg = 42666;
