...
import { IChildMaritalNotes, defaultValue } from '../../../../src/app/shared/model/child-marital-notes.model';
import reducer, {
  createEntity,
  deleteEntity,
  getEntities,
  ...
  partialUpdateEntity,
  reset,
} from './child-marital-notes.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CHILDMARITALNOTES_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CHILDMARITALNOTES actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CHILDMARITALNOTES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CHILDMARITALNOTES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CHILDMARITALNOTES actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CHILDMARITALNOTES actions', async () => {
      const arg = 42666;
