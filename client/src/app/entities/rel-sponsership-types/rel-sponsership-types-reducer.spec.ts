...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './rel-sponsership-types.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RELSPONSERSHIPTYPES_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_RELSPONSERSHIPTYPES actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_RELSPONSERSHIPTYPES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_RELSPONSERSHIPTYPES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_RELSPONSERSHIPTYPES actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_RELSPONSERSHIPTYPES actions', async () => {
      const arg = 42666;
