...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './sponsership-types.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SPONSERSHIPTYPES_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SPONSERSHIPTYPES actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SPONSERSHIPTYPES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SPONSERSHIPTYPES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SPONSERSHIPTYPES actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SPONSERSHIPTYPES actions', async () => {
      const arg = 42666;
