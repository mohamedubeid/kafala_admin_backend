...
import { IChildHealthNotes, defaultValue } from '../../../../src/app/shared/model/child-health-notes.model';
import reducer, {
  createEntity,
  deleteEntity,
  getEntities,
  ...
  partialUpdateEntity,
  reset,
} from './child-health-notes.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CHILDHEALTHNOTES_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CHILDHEALTHNOTES actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CHILDHEALTHNOTES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CHILDHEALTHNOTES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CHILDHEALTHNOTES actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CHILDHEALTHNOTES actions', async () => {
      const arg = 42666;
