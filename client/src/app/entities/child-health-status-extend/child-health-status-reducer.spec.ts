...
import { IChildHealthStatus, defaultValue } from '../../../../src/app/shared/model/child-health-status.model';
import reducer, {
  createEntity,
  deleteEntity,
  getEntities,
  ...
  partialUpdateEntity,
  reset,
} from './child-health-status.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CHILDHEALTHSTATUS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CHILDHEALTHSTATUS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CHILDHEALTHSTATUS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CHILDHEALTHSTATUS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CHILDHEALTHSTATUS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CHILDHEALTHSTATUS actions', async () => {
      const arg = 42666;
