...
const apiUrlV2 = 'api/v2/settings';
// Actions
...
export const updateEntity = createAsyncThunk(
  ...
  async (entity: ISetting, thunkAPI) => {
    const result = await axios.put<ISetting>(`${apiUrlV2}/${entity.id}`, cleanEntity(entity));
    thunkAPI.dispatch(getEntities({}));
    return result;
  },
  { serializeError: serializeAxiosError },
      ...
      .addMatcher(isFulfilled(getEntities), (state, action) => {
        ...
        return {
          ...
          entities: [...data].sort((a, b) => {
            ...
            return order === ASC ? (a[predicate] < b[predicate] ? -1 : 1) : a[predicate] > b[predicate] ? -1 : 1;
          }),
        };
      })
