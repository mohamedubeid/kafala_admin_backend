...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './setting.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SETTING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SETTING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SETTING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SETTING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SETTING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SETTING actions', async () => {
      const arg = 42666;
