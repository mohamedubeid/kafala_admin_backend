...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RELCHILDKAFEEL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_RELCHILDKAFEEL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_RELCHILDKAFEEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_RELCHILDKAFEEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_RELCHILDKAFEEL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_RELCHILDKAFEEL actions', async () => {
      const arg = 42666;
