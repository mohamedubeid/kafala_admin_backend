...
import { IChildSponsorShip, defaultValue } from '../../shared/model/child-sponsor-ship.model';
import reducer, {
  createEntity,
  deleteEntity,
  getEntities,
  ...
  partialUpdateEntity,
  reset,
} from './child-sponsor-ship.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CHILDSPONSORSHIP_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CHILDSPONSORSHIP actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CHILDSPONSORSHIP actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CHILDSPONSORSHIP actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CHILDSPONSORSHIP actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CHILDSPONSORSHIP actions', async () => {
      const arg = 42666;
