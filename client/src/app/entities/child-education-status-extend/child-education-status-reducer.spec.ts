...
import { EntityState } from '../../../../src/app/shared/reducers/reducer.utils';
import { IChildEducationStatus, defaultValue } from '../../../../src/app/shared/model/child-education-status.model';
import reducer, {
  createEntity,
  deleteEntity,
  getEntities,
  ...
  partialUpdateEntity,
  reset,
} from './child-education-status.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CHILDEDUCATIONSTATUS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CHILDEDUCATIONSTATUS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CHILDEDUCATIONSTATUS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CHILDEDUCATIONSTATUS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CHILDEDUCATIONSTATUS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CHILDEDUCATIONSTATUS actions', async () => {
      const arg = 42666;
