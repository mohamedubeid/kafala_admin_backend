          ...
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                ...
                id="child-marital-status-lostHousing"
                name="lostHousing"
                data-cy="lostHousing"
                check
                type="checkbox"
              ...
              <ValidatedField
                ...
                id="child-marital-status-lostLimbs"
                name="lostLimbs"
                data-cy="lostLimbs"
                check
                type="checkbox"
              ...
              <ValidatedField
                ...
                id="child-marital-status-lostSight"
                name="lostSight"
                data-cy="lostSight"
                check
                type="checkbox"
              />
              <ValidatedField
                label={translate('kafalaApp.childMaritalStatus.losthearorspeak')}
                id="child-marital-status-losthearorspeak"
                name="losthearorspeak"
                data-cy="losthearorspeak"
                check
                type="checkbox"
              />
              <ValidatedField
                label={translate('kafalaApp.childMaritalStatus.hasChronicDiseases')}
                id="child-marital-status-hasChronicDiseases"
                name="hasChronicDiseases"
                data-cy="hasChronicDiseases"
                check
                type="checkbox"
              />
              <ValidatedField
