...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './kafeel.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_KAFEEL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_KAFEEL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_KAFEEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_KAFEEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_KAFEEL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_KAFEEL actions', async () => {
      const arg = 42666;
