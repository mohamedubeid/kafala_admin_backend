...
export class Config {
  debugLogging = 'debug';
  'server.port' = '8080';
  'jhipster.clientApp.name' = 'kafala';
  ...
  'jhipster.mail.from' = 'kafala@localhost';
  'jhipster.swagger.default-include-pattern' = '/api/.*';
  'jhipster.swagger.title' = 'kafala API';
  'jhipster.swagger.description' = 'kafala API documentation';
  ...
  'eureka.instance.appname' = 'kafala';
  'eureka.instance.instanceId' = 'kafala:${random.value}';
